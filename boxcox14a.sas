...
=Description:
 ...
 (or folded-power transformation) for a linear regression with zero or 
 more predictors.
...
* FOLD=       Upper bound on response (FOLD>0)
