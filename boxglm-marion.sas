 ...
 *           on choice of power.                                     *
 *      Doc: http://www.math.yorku.ca/SCS/sasmac/boxglm.html         *
 *-------------------------------------------------------------------*
 *  Author:  Michael Friendly            <friendly@YorkU.ca>         *
 * Created:  23 Oct 1991 10:20:14                                    *
 * Revised:  08 Jun 2003 11:35:32                                    *
 * Version:  1.5                                                     *
...
run;
           data _null_; set mnull end=last;
           if last then do; put lambda=;
...
proc gplot data=&outplot;
   %do i = 1 %to &nmod;
      ...
      *axis4 label=("Box-Cox Power ('f=cgreek 'l'
                   =%sysfunc(putn(&elambda,5.3))" ) value=(h=1.3) offset=(2,9);
